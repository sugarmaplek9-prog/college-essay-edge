...
async function main() {
  ...
  const checks = {
    layer_a_tally_ok: JSON.stringify(layerA.final_tally) === JSON.stringify(contract.pass_fail_contract.layer_a.expected_final_tally),
...
Path('/Volumes/TOSHIBA EXT/College Essay/scripts/page3-release-candidate-validation.mjs').write_text(content)
print('rewrote page3-release-candidate-validation.mjs')
